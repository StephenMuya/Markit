...
export default function CallToAction({ onSignInClick }) {
  return (
    <section className="relative overflow-hidden bg-zinc-950 py-32 text-center text-white lg:py-48">
      ...
      <div className="absolute left-1/2 top-1/2 -z-10 h-[30rem] w-[50rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-zinc-800/20 blur-[120px]"></div>

      {/* Abstract grid pattern */}
      <div className="absolute inset-0 -z-20 bg-[linear-gradient(to_right,#ffffff04_1px,transparent_1px),linear-gradient(to_bottom,#ffffff04_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)]"></div>
